...
<body>
<!-- Side-Nav -->
<div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column" id="sidebar" style="background: #8caccb; ">
    <ul class="nav flex-column text-white w-100">
        <a href="#" class="nav-link h3 text-white my-2">
            <span style="color:#1D2A4D;"> Admin Dashboard</span>
        </a>
        ...
        <a href="/admin/alltailor" class="nav-link">
            <i class="bx bx-conversation" style="color:#1D2A4D;"></i>
            <span class="mx-2" style="color:#1D2A4D;">All tailors</span>
        </a>
...
<!-- bootstrap js -->
<script src="{{asset('js1/admin.js')}}"></script>
