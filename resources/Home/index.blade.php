            ...
            <div class="container py-5">
                <div class="row justify-content-start">
                    <div class="col-lg-8 text-center text-lg-start">
                        ...
                        <div class="pt-2">
                            {{-- <a href="" class="btn btn-light rounded-pill py-md-3 px-md-5 mx-2">Find tailor</a> --}}
                            <a href=""
                        ...
                        <div class="row g-0 bg-light rounded overflow-hidden">
                            <div class="col-12 col-sm-5 h-100">
                                <img class="img-fluid h-100"
                                     src="data:image/jpg;charset=utf8;base64,{{$tailor['image']}}"
                                     style="object-fit: cover;">
                            </div>
                            <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                                <div class="mt-auto p-4">
                                    <h3>{{$tailor['name']}}</h3>
                                    {{-- <h6 class="fw-normal fst-italic text-primary mb-4">{{App\Models\departments::find($tailor['department_id'])->name}}</h6> --}}
                                    <p class="m-0">{{$tailor['overview']}}</p>
                                </div>
